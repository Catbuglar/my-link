...
## 5. 커뮤니케이션 및 언어 규칙
사용자와의 대화 및 문서 작성 시 다음 규칙을 엄격히 준수합니다.
- **언어**: 모든 답변, 계획서(Implementation Plan), 태스크(Task), 워크스루(Walkthrough), 커밋 메시지는 기본적으로 **한국어**로 작성합니다.
- **명확성**: 모호한 부분은 추측하지 않고 사용자에게 질문하여 확인 후 진행합니다.
