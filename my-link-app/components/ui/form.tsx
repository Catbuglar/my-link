...
const FormContext = React.createContext<{ name: string }>({} as any)
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <p
      ref={ref}
      id={formMessageId}
      className={cn("text-xs font-medium text-destructive mt-1.5 animate-in fade-in slide-in-from-top-1", className)}
      {...props}
    >
      {body}
    </p>
